...
function oldLeagueTable(wrapper: HTMLElement, games: FootballGame[] | BasketballGame[], teams: (FootballTeam | BasketballTeam)[], params: {comparisonBtn?: boolean, comparisonTable?: boolean} = {comparisonBtn: false, comparisonTable: false}) {
